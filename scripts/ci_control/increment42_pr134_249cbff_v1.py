"""Dispatch only pinned Core CI for Increment 42 failed style evidence.
...
HEAD = "249cbff27116885835fd257facaeb89bc8441569"
TREE = "3499a72a50ecffac3171d0e1a5a971aef709613a"
PARENT = "d3764318a1f332e3fc216969e47fda710287e7a2"
PARENT_TREE = "4f4d062a405d66ccd3716198fc45f9becc7c26b1"
FAILED_HEAD = "d3764318a1f332e3fc216969e47fda710287e7a2"
PARENT_PARENT = "527fc8d20b4909931d425609f2012d8d09da4fd5"
CONTROL = "ci-control/nodal-42-pr134-249cbff-style-evidence-v1"
CONTROL_WORKFLOW = ".github/workflows/ci-control-42-pr134-249cbff.yml"
INVENTORY = Path("scripts/ci_control/increment42_pr134_249cbff_inventory.json")
INVENTORY_SHA256 = "985ee458eeade346ae62e2f0cb7cfe8eb6ddb721839410c00de6f1adc409d264"
WORKFLOWS = (
...
PRIOR_FAILURES = [{'run_id': 36256292650,
  'workflow_id': 338626156,
  'path': '.github/workflows/ci.yml',
  'run_attempt': 1,
  'jobs': [{'id': 108443599684,
            'name': 'contracts',
            'conclusion': 'failure',
...
def request(path, payload=None):
    ...
    req = urllib.request.Request(API + path, data=data, headers={
        ...
        "User-Agent": "Nodal-42-PR134-249cbff-style-evidence-v1",
