"""Dispatch only the two pinned Increment 42 formatter-repair checks.
...
HEAD = "4a1e9400fec8daacfdd927e22102cacc5574657c"
TREE = "f33a896608718ad0d1a472a4316ef2272627e408"
PARENT = "249cbff27116885835fd257facaeb89bc8441569"
PARENT_TREE = "3499a72a50ecffac3171d0e1a5a971aef709613a"
FAILED_HEAD = "249cbff27116885835fd257facaeb89bc8441569"
PARENT_PARENT = "d3764318a1f332e3fc216969e47fda710287e7a2"
CONTROL = "ci-control/nodal-42-pr134-4a1e940-formatter-repair-v1"
CONTROL_WORKFLOW = ".github/workflows/ci-control-42-pr134-4a1e940.yml"
INVENTORY = Path("scripts/ci_control/increment42_pr134_4a1e940_inventory.json")
INVENTORY_SHA256 = "aa2b0b8c8813e50809758ee14e54b6ff00aa2635bbc7b612ee340c5dcf4a926c"
WORKFLOWS = (
...
PRIOR_FAILURES = [{'run_id': 36257290430,
  'workflow_id': 338626156,
  'path': '.github/workflows/ci.yml',
  'run_attempt': 1,
  'jobs': [{'id': 108446380436,
            'name': 'contracts',
            'conclusion': 'failure',
            'steps': {'Validate contracts, style, and online provenance': 'failure',
                      'Capture failed style repair for review': 'success',
                      'Preserve failed style repair evidence': 'success'}},
           {'id': 108446380496,
            'name': 'scala',
            'conclusion': 'success',
...
def request(path, payload=None):
    ...
    req = urllib.request.Request(API + path, data=data, headers={
        ...
        "User-Agent": "Nodal-42-PR134-4a1e940-formatter-repair-v1",
...
def validate(definitions=True):
    ...
    require(parent["tree"]["sha"] == PARENT_TREE
            ...
            "failed parent ancestry/tree mismatch")
