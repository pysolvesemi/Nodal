  ...
  ^bb0:
    ...
    ^bb0:
      ...
      ^bb0:
        ...
        ^bb0:
          "nodal.analog_case_arm"() <{arm_id = "ControlTop.case_0.arm_0", is_default = false, labels = ["integer:+1"], metadata = {semantic_path = "ControlTop.case_0.arm_0"}, owner = "ControlTop"}> ({
          ^bb0:
