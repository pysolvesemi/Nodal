  ...
  ^bb0:
    ...
    ^bb0:
      ...
      ^bb0:
        ...
        %read_after_loop = "nodal.analog_variable_read"(%value) <{metadata = {semantic_path = "ControlTop.read_after_loop"}, owner = "ControlTop", read_id = "ControlTop.read_after_loop"}> : (!nodal.variable<"real", "1">) -> !nodal.quantity<"real", "1"> loc("AnalogControlFlow.scala":80:7)
      }) : () -> ()
    }) : () -> ()
  }) : () -> ()
}
