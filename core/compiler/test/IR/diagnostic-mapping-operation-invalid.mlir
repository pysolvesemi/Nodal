...
module {
  "nodal.module"() <{metadata = {semantic_path = "Top"}, sym_name = "Top"}> ({
    ...
    "nodal.net_drive"(%net, %driver, %value, %enable) <{metadata = {drive_level = "high", hierarchy_path = "Top", semantic_path = "Top.irq", source_end_column = 30 : i64, source_end_line = 70 : i64}, mode = "open_drain"}> : (!nodal.resolved<"open_drain", !nodal.bits<1>>, !nodal.driver<!nodal.bits<1>>, !nodal.bits<1>, i1) -> () loc("src/Top.scala":70:5)
  }) : () -> ()
}
