...
### Increment 13 — Elaboration and lexical domain context
...
### Increment 14 — Source locations and deterministic domain naming
...
### Increment 16 — Target-neutral domain IR
...
### Increment 54 — Domain, CDC/RDC, gate, mux, and escape implementation
...
### Increment 55 — Domain-aware hierarchy
...
### Increments 57, 59, and 60 — Mixed-signal verification and backend
