...
| [0025](0025-generated-procedural-testbench-projections.md) | Extend the single Nodal HVL/Verification IR architecture with generated procedural Verilog and Verilog-AMS testbench projections, while separating artifact generation from capability-checked simulator execution. |
...
ADR 0025 extends ADR 0023 with procedural HDL source projections. Nodal HVL and Verification Semantic IR remain authoritative; generated Verilog/Verilog-AMS testbench artifacts, native execution, UVM/UVM-MS, and each simulator run remain separate capability-checked layers with explicit parity evidence.
