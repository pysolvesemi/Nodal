"""Dispatch only the four pinned Increment 42 override-integration checks.
...
HEAD = "650a6710dc7d05082a9117339b0d4b86ce1ba3ab"
TREE = "c9e824c6712d322f924dcb80e7b4dffac62b570c"
PARENT = "5e877e1a4ae1b0ee06c810518b5d76cddce18c76"
CONTROL = "ci-control/nodal-42-pr134-650a671-integration-v1"
CONTROL_WORKFLOW = ".github/workflows/ci-control-42-pr134-650a671.yml"
INVENTORY = Path("scripts/ci_control/increment42_pr134_650a671_inventory.json")
INVENTORY_SHA256 = "1930b09e19a97ec52e9927f7c1139acddb1d69a10b2b20c436625d8145a61857"
WORKFLOWS = (
...
def request(path, payload=None):
    ...
    req = urllib.request.Request(API + path, data=data, headers={
        ...
        "User-Agent": "Nodal-42-PR134-650a671-integration-v1",
