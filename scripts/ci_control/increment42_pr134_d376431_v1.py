...
HEAD = "d3764318a1f332e3fc216969e47fda710287e7a2"
TREE = "4f4d062a405d66ccd3716198fc45f9becc7c26b1"
PARENT = "527fc8d20b4909931d425609f2012d8d09da4fd5"
PARENT_TREE = "9b1045f4a764bc2968ccf0d428ab0a14059014fd"
FAILED_HEAD = "527fc8d20b4909931d425609f2012d8d09da4fd5"
PARENT_PARENT = "d799776408de9a9a35ace62a0a5b2b3e52608fb6"
CONTROL = "ci-control/nodal-42-pr134-d376431-constructor-repair-v1"
CONTROL_WORKFLOW = ".github/workflows/ci-control-42-pr134-d376431.yml"
INVENTORY = Path("scripts/ci_control/increment42_pr134_d376431_inventory.json")
INVENTORY_SHA256 = "735441063498aeedc0abc15c2f95fe3633d85bf227016110c1e9d622bd1f1843"
WORKFLOWS = (
...
PRIOR_FAILURES = [{'run_id': 36255516464,
  'workflow_id': 338626156,
  'path': '.github/workflows/ci.yml',
  'run_attempt': 1,
  'jobs': [{'id': 108441443823,
            'name': 'contracts',
            'conclusion': 'failure',
           ...
           {'id': 108441443993,
            'name': 'scala',
            'conclusion': 'failure',
            'steps': {'Compile and test Scala core': 'failure',
...
def request(path, payload=None):
    ...
    req = urllib.request.Request(API + path, data=data, headers={
        ...
        "User-Agent": "Nodal-42-PR134-d376431-constructor-repair-v1",
