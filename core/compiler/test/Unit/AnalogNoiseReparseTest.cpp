...
int main() {
  for (llvm::StringRef call : {
           "white_noise(0, \"zero\")",
           "white_noise((power * 1e-18), \"same<+report//label\")",
           "white_noise((V(p, n) * V(p, n)), \"runtime\")",
           "flicker_noise(power, -1, \"negative exponent\")",
           "flicker_noise(sqrt(4), 0.5, \"fractional\")",
           "noise_table('{0, 1}, \"single point\")",
  ...
  for (llvm::StringRef call : {
           "white_noise(1)",
           "white_noise(1, \"\")",
           "white_noise(1, 2, \"extra\")",
           "flicker_noise(1, \"missing exponent\")",
           "flicker_noise(1, 2, 3, \"extra\")",
           "noise_table('{}, \"empty\")",
           "noise_table('{1, 2, 3}, \"odd\")",
           "noise_table({1, 2}, \"missing apostrophe\")",
           "noise_table(\"file.dat\", \"unsupported\")",
           "white_noise($random(), \"injected\")",
           "white_noise(white_noise(1, \"inner\"), \"nested\")",
           "white_noise(1, \"bad\\label\")",
           "white_noise(1, \"new\nline\")",
           "white_noise(1, \"ok\"); $finish;",
           "white_noise(1e999, \"nonfinite\")",
           "white_noise(1, \"ok\") trailing",
           "not_noise(1, \"unknown\")"}) {
