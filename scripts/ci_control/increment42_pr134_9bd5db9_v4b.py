"""Dispatch only the pinned Increment 42 formatting-repaired native hierarchy checks.
...
HEAD = "9bd5db950c7e103bf86807276f7dc0814b1a735b"
TREE = "e660f8d0740845a1b69767028c36c134bb94676a"
PARENT = "e775281338502b4aea9885796baa5fa0908de1fd"
CONTROL = "ci-control/nodal-42-pr134-9bd5db9-targeted-v4b"
WORKFLOWS = (
...
# The four source-formatting failures and the independently completed evidence run
# on the immediate parent. These are historical evidence only.
FAILED_RUNS = (
    (35842864686, 338626156, "core"),
    (35842875660, 342183625, "increment21"),
    (35842886641, 342322970, "increment22"),
    (35842896416, 342865392, "increment23"),
)
PARENT_SUCCESS = (35842906814, 352989730)
...
def request(path, payload=None):
    ...
    req = urllib.request.Request(API + path, data=data, headers={
        ...
        "User-Agent": "Nodal-42-PR134-9bd5db9-targeted-v4",
