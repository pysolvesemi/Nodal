      ...
      ^bb0:
        ...
        ^bb0:
          ...
          ^bb0:
            ...
            "nodal.analog_if_arm"() <{arm_id = "ControlTop.if_2.otherwise", condition_dimension = "", condition_kind = "", condition_reads = [], condition_value = "", is_else = true, metadata = {semantic_path = "ControlTop.if_2.otherwise"}, owner = "ControlTop", stage = "else", static_value = true, static_value_present = false}> ({
            ^bb0:
