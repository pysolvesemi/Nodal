...
LogicalResult verifyAnalogNumericOperation(Operation *operation) {
  ...
  if (operation->getName().getStringRef() == "nodal.analog_transfer")
    return verifyAnalogTransferOperation(operation);
