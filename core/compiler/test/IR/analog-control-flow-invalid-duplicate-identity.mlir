    ...
    ^bb0:
      ...
      ^bb0:
        ...
        ^bb0:
          ...
          ^bb0:
            "nodal.analog_assign"(%value) <{analyses = ["dc", "transient"], authored_order = 0 : i64, guard_dimension = "", guard_kind = "", guard_present = false, guard_reads = [], guard_value = "", metadata = {semantic_path = "ControlTop.statement_0", value = "1.0"}, owner = "ControlTop", statement_id = "ControlTop.case_0", value_dimension = "1", value_kind = "real"}> : (!nodal.variable<"real", "1">) -> () loc("AnalogControlFlow.scala":20:9)
          }) : () -> ()
