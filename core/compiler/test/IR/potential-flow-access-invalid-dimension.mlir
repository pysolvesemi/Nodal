module {
  ...
  ^bb0:
    ...
    ^bb0:
      %bad = "nodal.terminal_access"(%p) <{function = "Across", kind = "potential", metadata = {}, source_path = "BadDimension.bad"}> : (!nodal.terminal<"electrical">) -> !nodal.quantity<"real", "current">
    }) : () -> ()
  }) : () -> ()
}
